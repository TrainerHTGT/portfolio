...
export default function Sidebar() {
  ...
  const iconList = [
    ...
    {
      component: linkedin,
      href: 'https://www.linkedin.com/in/karan-chandra-474502235?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app'
    
    },
    {
      component: gmail,
      href: 'karanshankhwar24@gmail.com'
    }
  ];
  const item = {
  ...
  return (
    <div className='sidebar'>
      <div className='topHashtag'>#DigitalMaven</div>
      <div className='topHashtag'>#TechTrendsetter</div>
      <div className='topHashtag'>#content creator</div>
      <h1>
      ...
      >
        <img src="https://i.postimg.cc/dtZxdv8C/Whats-App-Image-2024-01-17-at-17-37-53-0d12976f.jpg"className='my-img' />
      </motion.div>
